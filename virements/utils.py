...
def get_translations(langue):
    translations = {
        ...
        'nl': {
            'titre_initiation': 'INTERNATIONALE OVERSCHRIJVINGSOPDRACHT',
            'titre_rejet': 'KENNISGEVING VAN AFWIJZING OVERSCHRIJVING',
            'beneficiaire': 'BEGUNSTIGDE',
            'donneur_ordre': 'OPDRACHTGEVER',
            'compte': 'Rekeningnummer',
            'bic': 'BIC/SWIFT-code',
            'montant': 'Bedrag',
            'devise': 'Valuta',
            'date': 'Uitvoeringsdatum',
            'numero': 'Referentie',
            'banque': 'Uitgevende instelling',
            'frais': 'Omleidingskosten',
            'motif': 'Reden van afwijzing',
            'signature': 'Afdeling Operaties',
            'reference': 'Transactiereferentie',
            'statut': 'Status',
            'details_operation': 'TRANSACTIEDETAILS',
            'informations_parties': 'PARTIJINFORMATIE',
            'avis_important': 'BELANGRIJKE MEDEDELING',
            'msg_rejet': 'Deze overschrijving is afgewezen om de hieronder vermelde reden.',
            'email': 'E-mail',
            'en_lettres': 'In letters',
            'a_transferer': 'over te schrijven',
            'montant_initial': 'Oorspronkelijk bedrag',
            'date_rejet': 'Datum van afwijzing',
            'beneficiaire_concerne': 'Betrokken begunstigde',
            'compte_beneficiaire': 'Rekening begunstigde',
            'signature_cachet': 'Gemachtigde handtekening en stempel',
            'rejete': 'AFGEWEZEN',
            'dept_operations': 'AFDELING INTERNATIONALE OPERATIES',
            'systeme_gestion': 'Beheersysteem Overschrijvingen',
            'document_confidentiel': 'Dit document is vertrouwelijk en uitsluitend bestemd voor de vermelde begunstigde.',
            'reproduction_interdite': 'Elke reproductie of ongeoorloofd gebruik is ten strengste verboden.',
            'document_genere': 'Document automatisch gegenereerd op',
            'page': 'Pagina',
            'statut_traitement': 'IN BEHANDELING',
            'donneur_ordre_label': 'De opdrachtgever',
            'visa_banque': 'Bankvisum',
            'montant_virement': 'BEDRAG VAN DE OVERSCHRIJVING',
        },
    }
