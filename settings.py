...
EMAILJS_TEMPLATE_ID_INITIATION = os.getenv('EMAILJS_TEMPLATE_ID_INITIATION', 'your_template_id_initiation')
EMAILJS_TEMPLATE_ID_REJET = os.getenv('EMAILJS_TEMPLATE_ID_REJET', 'your_template_id_rejet')
